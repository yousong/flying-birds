...
ip addr add $ep0/24 dev veth0
"
ip netns exec ns1 bash -c "
ip link set lo up
ip link set veth1 up
ip addr add $ep1/24 dev veth1
"

ip netns exec ns0 bash -c "
ip link add dev wg0 type wireguard
wg set wg0 listen-port 21841 private-key <(echo $pri0) peer $pub1 endpoint $ep1:21841 allowed-ips $nets1 persistent-keepalive 5
...
wg set wg1 listen-port 21841 private-key <(echo $pri1) peer $pub0 endpoint $ep0:21841 allowed-ips $nets0 persistent-keepalive 5
